...
impl BridgeConfig {
    pub fn from_env() -> Result<Self, ConfigError> {
        ...
        // IronClaw reusa HTTP_PORT en algunas versiones cuando GATEWAY_ENABLED=true;
        // probamos GATEWAY_PORT primero, después HTTP_PORT, después default 3000.
    ...
    /// URL completa del WebSocket, incluyendo `?token=` si hay auth.
